...
if (typeof CONFIG_CALLBACK_WAIT_FOR_UUID === "undefined") var CONFIG_CALLBACK_WAIT_FOR_UUID = true;
...
PhoneGap.addConstructor = function(func) {
	...
	if ( ( state == 'loaded' || state == 'complete' ) && (DeviceInfo.uuid != null || !CONFIG_CALLBACK_WAIT_FOR_UUID) )
    {
        func();
    }
    else
